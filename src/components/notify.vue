  ...
  <f7-page :page-content="false" >
    ...
    <f7-tabs>
      ...
      <f7-tab id="tab-3" class="page-content">
        <f7-list mediaList class="notify-list" >
          <f7-list-item v-for="(c,index) in comments" :key="index" :title="c.sender" :subtitle="c.content" :after="dateformate(c._id,'MM-dd hh:mm')" :link="'/tipsNotify/?relateId='+c.relateId+'&type='+c.type">
