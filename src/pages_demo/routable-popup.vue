  ...
  <f7-popup>
    <f7-page>
      <f7-navbar title="Routable Popup">
        <f7-nav-right>
          <f7-link popup-close>Closepage-dynamic-routingpage-dynamic-routingpage-dynamic-routingpage-dynamic-routingpage-dynamic-routingpage-dynamic-routing</f7-link>
        </f7-nav-right>
      </f7-navbar>
      <f7-block strong>
